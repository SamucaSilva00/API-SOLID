...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n}\n\nenum Role {\n  ADMIN\n  MEMBER\n}\n\nmodel User {\n  id            String   @id @default(uuid())\n  name          String\n  email         String   @unique\n  password_hash String\n  role          Role     @default(MEMBER)\n  created_at    DateTime @default(now())\n\n  checkIns CheckIn[] //aqui usamos camelCase ja que nao salva no banco e la na frente vamos poder usar no JS com camelCase\n\n  @@map(\"users\") //indica o nome da tabela no banco de dados\n}\n\nmodel CheckIn {\n  id           String    @id @default(uuid())\n  created_at   DateTime  @default(now())\n  validated_at DateTime?\n\n  user    User   @relation(fields: [user_id], references: [id]) //aqui relacionamos o checkIn com o usuario\n  user_id String\n\n  gym    Gym    @relation(fields: [gym_id], references: [id]) //aqui relacionamos o checkIn com a academia\n  gym_id String\n\n  @@map(\"check_ins\")\n}\n\nmodel Gym {\n  id          String  @id @default(uuid())\n  title       String\n  description String?\n  phone       String?\n  latitude    Decimal\n  longitude   Decimal\n\n  checkIns CheckIn[]\n\n  @@map(\"gyms\")\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
